...
save_page_content = dbc.ModalBody(
    [
        ...
        dcc.Markdown(
            "Please input the name of the metadata table which you wish to add."),
...
add_metadata_table = dbc.Modal(
    [
        ...
        dbc.ModalFooter([
            ...
            dbc.Button("Add", id="add-metadata-table-button-to-page",
                       className="ml-auto"),
            dbc.Button("Close", id="close-metadata-table-add-modal",
                       className="ml-auto"),
        ]),
...
def open_metadata_modal(app):
    ...
    @app.callback(
        ...
        [Input("add-metadata-table-button", "n_clicks"),
         Input("close-metadata-table-add-modal", "n_clicks")],
    ...
    def add_new_tab(n_clicks, list_new_tabs, new_tab_label, existing_tabs):
        if n_clicks and new_tab_label:
            ...
            new_tab = dcc.Tab(
                ...
                children=[
                    # Add this element to your layout
                    html.Div(
                        id=f"new-tab-ids-{new_tab_label}", style={"display": "none"})
                ]
            )
