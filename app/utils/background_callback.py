...
def callback(set_progress, n_clicks, store):
    ...
    try:
        ...
        return {}, True, True, "An error has occurred. Please see the log file for more information.", f'```{error_message}```'       
            ...
            for line in iter(process.stdout.readline, b''):
                ...
                # Process the line if 'Running' is in the line
                    ...
                    if well_running not in wells_analyzed:
                        ...
                        img_path = Path(
                                    volume, f'input/{platename}/TimePoint_1/{plate_base}_{wells_analyzed[-1]}.TIF')
